...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView todayConfirm, todayRecovered, todayDeath, todayTests, dateTV, cname;
...
//                    todayTests.setText(NumberFormat.getInstance().format(Integer.parseInt(list.get(i).getTotalTests())));
